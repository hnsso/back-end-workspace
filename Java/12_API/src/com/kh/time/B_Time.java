...
public class B_Time {
	 ...
	 * LocalTime, LocalDateTime, ZonedDateTime 클래스 포함 - 날짜와 시간에 대한 다양한 메서드를 제공
	 */
...
//		b.method2();
	...
	public void method1() {
		...
		System.out.println(now.getMonthValue() + "월"); // 숫자로 표현해서 1이 나온다
		...
		System.out.println("loclaDate 2 : " + localDate);
	...
	/*
	 * Period 와 Duration - 날짜와 시간 간격을 표현하기 위한 클래스 - Period : 두 날짜 간의 차이 - Duration :
	 * 시간의 차이
	 */
	public void method2() {

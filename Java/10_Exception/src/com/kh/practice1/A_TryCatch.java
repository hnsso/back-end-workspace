...
public class A_TryCatch {
	 ...
	 * 예외는 발생하더라도 수습될 수있는 비교적 덜 심각한 것
	 * 
	 ...
	 * Exception - 
	 * 		IOException - FileNoteFoundException, SocketException
	 ...
	 * } [ finally {
	 * 
	 *		// 예외가 발생하거나 발생하지 않든 무조건 실해되는 코드들
...
//			e.printStackTrace();
            ...
            // getMessage() : 발생한 예외클래스의 객체에 저장된 메시지를 얻을수 있음
		}

...
public class Car {
	 ...
	 * 
	 * [+]public : 접근 제한이 전혀 없음
	 * [#]protected : 같은 패기지 내에서, 그리고 다른 패기지의 자손 클래스에서 접근 가능
	 * [ ]default : 같은 패기지 내에서만 접근이 가능 !
	...
	// private 은 같은 클래스 내에서만 가능! 
	private String color; // 색상
	private String gearType; // 자동 or 수동
	private int door; // 문 의 개수
...
//		this.gearType = gearType;
	...
	*/
	@Override
	public String toString() {
		return "Car [color=" + color + ", gearType=" 
						+ gearType + ", door=" + door + "]";
	}

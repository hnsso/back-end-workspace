...
//		c.practice7();
	...
	public void practice1() {
    	...
    	int number = sc.nextInt(); // 변수하나여서 nextint
    	if(number > 0) {
    		if(number % 2 == 0) {
	...
	/*
	 * 3. A 피자가게는 피자를 두 조각에서 열 조각까지 원하는 조각 수로 잘라준다. 피자 조각 수와 피자를 먹는 사람의 수를 
	 * 입력받아 한 사람 당 최소 한 조각 이상 피자를 먹으려면 최소 몇 판의 피자를 시켜야 하는지 출력하세요.
	 * 
	 * 피자 조각 수 : 7 
	 * 피자 먹는 사람 수 : 10 
	 * 2
	...
	/*
	 * 4. 국어, 영어, 수학 세 과목의 점수를 키보드로 입력 받고 합계와 평균을 계산하고 합계와 평균을 이용하여 합격 / 
	 * 불합격 처리하는 기능을 구현하세요. (합격 조건 : 세 과목의 점수가 각각 40점 이상이면서 평균이 60점 이상일 경우) 
	 * 합격 했을 경우 과목 별 점수와 합계, 평균, “축하합니다, 합격입니다!”를 출력하고 불합격인 경우에는
	 *  “불합격입니다.”를 출력하세요.
	 * 
	...
	/*
	 * 8. 키, 몸무게를 double로 입력 받고 BMI지수를 계산하여 계산 결과에 따라 저체중 
	 * / 정상체중 / 과체중 / 비만을 출력하세요. BMI = 몸무게 / (키(m) * 키(m)) 
	 * BMI가 18.5미만일 경우 저체중 / 18.5이상 23미만일 경우 정상체중 BMI가
...
//		}
	...
	public void practice9() {
		...
		System.out.printf("%d %c %d = 3", num1, op, num2);
	}

	/*
	 * 10. 아래 예시와 같이 메뉴를 출력하고 메뉴 번호를 누르면 
	 * “OO메뉴입니다“를, 종료 번호를 누르면 “프로그램이 종료됩니다.”를 출력하세요
	 * 
	...
	public void practice11() {
		...
		double score4 = result * 0.2;
		
		double sum = num1 * 0.2 + num2 * 0.3 + num3 * 0.3 + num4 * 0.2 ;
		
		
		
		if(sum >= 70 && result >= 70) {
			System.out.println("중간 고사 점수 :" + score1);
			System.out.println("기말 고사 점수 :" + score2);
			System.out.println("과제 점수 :" + score3);
			System.out.println("출석 점수 :" + score4);

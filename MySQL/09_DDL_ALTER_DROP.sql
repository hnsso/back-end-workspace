...
/*
    ...
    - ADD [CONSTRAINT 제약조건명] CHECK(컬럼명)
...
/*
	2-2. 제약조건 삭제
    - NOT NULL : ALTER TABLE 테아블명 MODIFY 컬럼명 NULL;
    - 나머지 : ALTER TABLE 테아블명 DROP CONSTRAINT 제약조건명;
*/
...
-- 어딘가에서 참조되고 잇는 부모테이블은 함부로 삭제가 안됨!

...
// Controller의 공장역할( Factory )
public class HandlerMapping {

	private static HandlerMapping handler = new HandlerMapping();
	// 싱글톤 패턴 < 캡슐화 >
	// => 특정 클래스의 객체가 오직 한개만 존재하도록 하기 위해서
	...
	public Controller createController(String command) {
		Controller controller = null; // 객체 생성!
		
		
		
		// 우리는 Controller에서 만든거를 mapping으로 등록해야한다 !! 
		//                 나이거 주문했어 !
		...
		return controller; // 객체생성한다음 리턴하겠다 마지막
	}
